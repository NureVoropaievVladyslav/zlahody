...
export class ChatWindowComponent {
    ...
    constructor(private chatsHubService: ChatsHubService, private activatedRoute: ActivatedRoute, private chatService: ChatsService) { }

    ngOnInit() {this.chatsHubService.connect().then(() => {
    ...
    sendMessage(): void {
        if (this.message) {
            ...
            this.chatService.sendMessage(messageToSend).subscribe(() => {
                this.chatsHubService.sendMessage(messageToSend.chatId, messageToSend.content).then(() => {
                    this.messages.push({
